...
uses
  ...
  Datasnap.DSHTTP, SeverModule.Pessoa;
...
procedure TWebModule1.DSServerClassPessoaGetClass(DSServerClass: TDSServerClass;
  var PersistentClass: TPersistentClass);
begin
  PersistentClass :=  SeverModule.Pessoa.TSMPessoa;
end;
